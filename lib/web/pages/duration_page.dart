...
import 'package:project_ui/web/widgets/slider.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(top: ((30 / 1080) * screenHeight)),
                child: Container(
                  width: ((600 / 1920) * screenWidth),
                  height: ((300 / 1080) * screenHeight),
                    ...
                    children: [
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            "Your current stituation : ${widget.plate}",
                            style: TextStyle(
                              color: Colors.black,
